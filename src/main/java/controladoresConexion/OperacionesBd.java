	...
	public static Usuario login(String username, String password) throws SQLException{
		...
		if(idUsuario!=0){
			...
			if(idTipoUsuario==2){
				...
				System.out.println(listaTutor.get(0));
				System.out.println(listaTutor.get(1));
				...
				while (rs.next()){
					...
					System.out.println(listaTutor.get(0));
					System.out.println(listaTutor.get(1));
					System.out.println(empresa.getAcronimo());
					System.out.println(empresa.getDireccionFiscal());
					System.out.println(empresa.getEmail());
					System.out.println(empresa.getIdEmpresa());
					System.out.println(empresa.getNombre());
					System.out.println(empresa.getRegion());
					System.out.println(empresa.getTutor().get(0));
				}
			}
				...
				while (rs.next()){
					...
					System.out.println(empresa.getNombre());
					System.out.println(empresa.getRegion());
					System.out.println(responsableEmpresa.getTutor().get(0).getIdUsuario());
				}
			}
