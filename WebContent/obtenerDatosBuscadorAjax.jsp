...
<body>
	...
	System.out.println("La variable de sesion: "+usuario.getIdUsuario());
	if(q.length()<=3){
		...
		Conexion conexion= new Conexion();
		Statement st= conexion.conectar().createStatement();
		ResultSet rs= st.executeQuery("SELECT * FROM datosPersonales where nombre like '%"+q+"%' OR apellido1 LIKE '%"+q+"%' OR apellido2 LIKE '%"+q+"%' OR dni LIKE '%"+q+"%'");
