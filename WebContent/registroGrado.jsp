...
<div class="container">
        	...
        	<div class="panel panel-default">
        		<div class="panel-heading" <% if ((String)session.getAttribute("temaCaja")== "box-inverse"){out.println("style='background:#7a2b24;color:white;'");}else{}%>>
			    		...
			    		<form id="formRegistro" role="form" method="post" action=".././validarRegistroCentro.jsp">
			                ...
			                <input type="text" name="nombreGrado" id="nombre" class="form-control input-sm floatlabel" placeholder="Nombre de la familia profesional">
			    					</div>
			    				</div>
			    			</div>
			    			<div class="col-xs-12 col-sm-12 col-md-12">
			    					<div class="form-group">
			                			<select name='nombreCentro' id='centroRegistro' onchange="obtenerDatosRegistro(this.value)">
			    				...
			    				<div id="datosConsultasFamiliaProfesionalRegistro"></div>
    ...
    <script>
function obtenerDatosRegistro(str) {
    if (str == "") {
        document.getElementById("centroRegistro").innerHTML = "";
        return;
    } else { 
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById("datosConsultasFamiliaProfesionalRegistro").innerHTML = xmlhttp.responseText;
            }
        };
    ...
    if(document.getElementById("gradoRegistroRegistro")){
    	document.getElementById("datosConsultasGradoRegistro").innerHTML="";
    }
...
function obtenerDatosFamiliaProfesionalRegistro(str) {
    if (str == "") {
        document.getElementById("centroRegistro").innerHTML = "";
        return;
    } else { 
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById("datosConsultasGradoRegistro").innerHTML = xmlhttp.responseText;
            }
        };
    ...
    if(document.getElementById("gradoRegistro")){
    	document.getElementById("datosConsultasGradoRegistro").innerHTML="";
    }
    if(document.getElementById("especializacionRegistro")){
    	document.getElementById("datosConsultasEspecializacionRegistro").innerHTML="";
    }
